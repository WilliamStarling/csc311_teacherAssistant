...
public class Assignment {
	...
	/*
	 * This method is the constructor for the assignment class for the student assignment list. 
	 * It takes the parameters given and updates the data members to hold these values.
	 * @param newName: The name of the assignment
	 * @param newDescription: The description of the assignment
	 * @param newType: What type of assignment it is (homework, quiz, test, etc. user will select
	 * 	a type and then this will be translated into an integer by upper layer.
	 * @param possiblePoints: How many points the assignment is out of.
	 * @param grade: How many points were given.
	 */
	public void Assignment(String newName, String newDescription, int newType, int possiblePoints, String dueDate, float grade) {
		f_name = newName;
	...
	/*
	 * This is the constructor for the Assignment class for the a class's assignment list.
	 * It takes the parameters given and updates the data members to hold these values.
	 * @param newName: The name of the assignment
	 * @param newDescription: The description of the assignment
	 * @param newType: What type of assignment it is (homework, quiz, test, etc. user will select
	...
	public void Assignment(String newName, String newDescription, int newType, int possiblePoints, String dueDate) {
		f_name = newName;
		f_description = newDescription;
		f_type = newType;
		f_possiblePoints = possiblePoints;
	 ...
	 * @param newDescription: the new description that you want to update f_description to have.
	 */
	 ...
	 * @param newPossible: the new max that you want to update f_possiblePoints to have.
	 */
	 ...
	 * @param newGrade: the new grade that you want to update f_grade to have.
	 ...
	 * @param newDueDate: the new due date that you want to update f_dueDate to have.
	 */
	 ...
	 * @return: returns an integer that corresponds to a specific type. 0 is homework,
	 * 1 is quiz, 2 is test/exam, and 3 is final.
	 */
	public int getType() {
		return f_type;
	}
