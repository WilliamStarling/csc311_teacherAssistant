...
/**
 * This frame displays a screen for creating a new account.
 * 
 * @author willi
 */
public class CreateAccountFrame implements ActionListener {
	...
	/**
	 * This is the java frame, it displays the name of the app, boxes for the
	 * username, password, and password confirmation, a button for creating the
	 * account with the provided information, and for going back to the login
	 * screen. If the password isn't the same, or if the user already exists, it
	 * lets the user know.
	 * 
	 * @param currentSession The current console session, passed so it can be
	 *                       preserved and continued to be used.
	 */
	CreateAccountFrame(Control currentSession) {
		 ...
		 */
		f_userNameTextBox.setBounds(550, 281, 250, 28);// 250 pixels long 28
														// high
		...
		/*
		 * Creating the Password confirmation text above password confirmation
		 * box
		 */
		 ...
		 */
		f_passwordTextBox.setBounds(550, 345, 250, 28);// 250 pixels long 28
														// high
		 ...
		 */
		f_passwordConfirmBox.setBounds(550, 420, 250, 28);// 250 pixels long 28
															// high
		...
		f_passwordMismatch.setText(
				"The password entries do not match, please double check and try again.");
	...
	/**
	 * the action performer for the frame. it checks which button was pressed,
	 * or if the enter button was pressed while in a text box, and performs the
	 * respective action.
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if ((e.getSource() == f_createButton)
				|| e.getSource() == f_userNameTextBox
				|| e.getSource() == f_passwordTextBox
				|| e.getSource() == f_passwordConfirmBox) {
