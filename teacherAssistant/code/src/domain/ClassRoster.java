...
/**
 * This class will store the data for a subject, including the name, list of
 * students in it, list of assignments for it, and seating chart.
 * 
 * @author william
 *
 */
public class ClassRoster implements Serializable {
	 ...
	 * It takes the name given and creates new lists to store the seating
	 * charts, assignments, and students.
	 * 
	 ...
	 * 
	 * @return returns a pointer to the assignment, so that Control can
	 *         immedietly open it up as the current assignment for editing.
	 */
	...
	/**
	 * This creates a new student and adds them the student list, and returns a
	 * pointer to it.
	 * 
	 * @param name the name of the new student being added.
	 * 
	 * @return Returns a pointer to the new student object, so that Control can
	 *         set it as the current student and immediately open up it's info
	 *         for editing.
	 */
	 ...
	 * 
	 * @return the assignment that comes up after searching with the supplied
	 *         name. returns "null" if does not exist. This case will be handled
	 *         in a higher layer.
	 */
	 ...
	 *         returns "null" if does not exist. This case will be handled in a
	 *         higher layer.
	 */
	...
	/**
	 * This returns the TreeMap object containing the list of all students, for
	 * display purposes.
	 * 
	...
	/**
	 * This returns the TreeMap object containing the list of all assignments,
